...
class SparkDiversityEvaluation:
    ...
    def __init__(
        ...
        * Serendipity - The "unusualness" or "surprise" of recommendations to a user. When 'col_relevance' is used,
        ...
        :Citation:
            ...
            <NAME> and <NAME>, Evaluating Recommendation Systems,
            Recommender Systems Handbook pp. 257-297, 2010.

            <NAME>, <NAME>, <NAME> and <NAME>, Auralist: introducing
            serendipity into music recommendation, WSDM 2012

            <NAME>, <NAME>, and <NAME>, Novelty and diversity metrics for recommender systems:
            choice, discovery and relevance, ECIR 2011

            <NAME>, Serendipity: Accuracy’s unpopular best friend in Recommender Systems,
    ...
    def _get_cooccurrence_similarity(self, n_partitions):
        ...
        :Citation:
            ...
            <NAME>, <NAME>, <NAME> and <NAME>, Auralist:
    ...
    def _get_intralist_similarity(self, df):
        ...
        :Citation:
            ...
            Ziegler, McNee, <NAME> Lausen, 2005.
        """
    ...
    def user_item_serendipity(self):
        ...
        :Citation:
            ...
            E<NAME>, Serendipity: Accuracy’s unpopular best friend in Recommender Systems,
            eugeneyan.com, April 2020
